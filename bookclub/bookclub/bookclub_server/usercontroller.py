...
#            rating_user = random.randint(1, 489)
#            if rating_user != i:
#                ratingRow = UserRating.objects.filter(Q(rated_user_id=i) & Q(rating_user_id=rating_user))
#                if ratingRow.exists():
#                    continue
#                else:
#                    ratingRow = UserRating(rating=new_rating, rated_user_id=i, rating_user_id=rating_user)
#                    ratingRow.save()
#                index = index + 1
#        i = i + 1
#    return JsonResponse({'success': 'yes'})